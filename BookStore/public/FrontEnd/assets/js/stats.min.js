(function () {
  function k() {
    if (
      ((i === "checkout_contact_view" || i === "checkout_all_view") &&
        ((n.value = Bizweb.Checkout.fbEvent
          ? Bizweb.Checkout.fbEvent.value
          : ""),
        (n.content_ids = Bizweb.Checkout.fbEvent
          ? Bizweb.Checkout.fbEvent.content_ids
          : [])),
      i === "product_view" || i === "product_view_from_search")
    ) {
      var f = [];
      f.push(BizwebAnalytics.meta.product.id);
  ...
  function at() {
    ...
    n.phone = Bizweb.checkout.billing_address.phone;
  ...
  var o,
    t = (function () {
      ...
      function u(n, t, i, r) {
        if (
          (BizwebAnalytics.meta.customer &&
            (t.customer_id = BizwebAnalytics.meta.customer.id),
          o)
        )
          (t.fp = o),
            fetch(n, {
    ...
    nt,
    v;
  t.getCookie("_landing_full_page") ||
    t.getCookie("_landing_type") ||
    !Bizweb.template ||
    (t.setCookie("_landing_full_page", location.href, 21600),
    t.setCookie("_landing_type", Bizweb.template, 21600));
  var y = window.BizwebAnalytics.tracking_url,
    s = t.getCookie("_s"),
    e = t.getCookie("_v"),
    tt = !!sessionStorage.getItem("active"),
    it = t.getCookie("_landing_full_page"),
    rt = t.getCookie("_landing_type"),
    ut = unescape(t.getCookie("_landing_page")),
    l = !1;
  ...
  n = {
    ...
    visitor_id: ht,
    reference_site: et,
    origin_reference_site: ot,
    current_site: ct,
    landing_type: rt,
    landing_page: ut,
    landing_full_page: it,
    visit_returning: l,
    product_alias: b,
    first_time_access: Bizweb.first_time_accessed,
    currency: BizwebAnalytics.meta.currency,
    from_product_view: w,
    article_id: BizwebAnalytics.meta.article
      ? BizwebAnalytics.meta.article.id
      : undefined,
  ...
  a.prototype.handleXhrDone = function (i) {
    try {
      switch (i.url) {
        case "/cart/add.js":
          if (i.xhr.responseText) {
            var e = JSON.parse(i.xhr.responseText),
              o = [];
            o.push(e.product_id);
            ...
            new URL(location.href).pathname === "/search" &&
              ((n.action = "search"), t.postData(f, n, u, r));
          }
          break;
        case "/cart/change.js":
          t.getParamValue("quantity", i.body) === "0" &&
            ((n.variant_id = t.getParamValue("variantId", i.body)),
  ...
  nt = XMLHttpRequest.prototype.send;
  XMLHttpRequest.prototype.open = function (n, t) {
    return (this._url = t), (this._method = n), g.apply(this, arguments);
  };
          ...
          try {
            switch (i.url) {
              case "/cart/add.js":
                ...
                break;
              case "/cart/change.js":
                t.getParamValue("quantity", query) === "0" &&
                  ((n.variant_id = t.getParamValue("variantId", i.body)),
                  (n.action = "remove_from_cart"),
                  t.postData(f, n, u, r));
            }
