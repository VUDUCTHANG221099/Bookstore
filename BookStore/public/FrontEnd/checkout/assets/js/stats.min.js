(function() {
  function d() {
      (i === "checkout_contact_view" || i === "checkout_all_view") && (n.value = Bizweb.Checkout.fbEvent ? Bizweb.Checkout.fbEvent.value : "",
      ...
      (i === "product_view" || i === "product_view_from_search") && (n.value = BizwebAnalytics.meta.product.price,
  ...
  function vt() {
      ...
      n.num_items = Bizweb.checkout.line_items.reduce((n,{quantity: t})=>n + t, 0);
  ...
  var o, t = function() {
      ...
      function u(n, t, i, r) {
          if (BizwebAnalytics.meta.customer && (t.customer_id = BizwebAnalytics.meta.customer.id),
          o)
              t.fp = o,
              fetch(n, {
                  method: "POST",
